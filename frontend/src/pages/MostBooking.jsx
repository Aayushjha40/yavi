      ...
      <Slider {...settings}>
        {cards.map(card => (
          <div key={card.id} className="p-4" >
            <div className="w-[270px] h-[350px] bg-white m-3 rounded-sm shadow-lg flex flex-col hover:bg-gray-200 transition-colors duration-300 cursor-pointer" onClick={() => handleCardClick(card.id)}>
