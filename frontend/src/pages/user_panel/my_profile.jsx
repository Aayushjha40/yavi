...
export default function MyProfile() {
  ...
  const handleProfileImageChange = (e) => {
    ...
    if (file) {
      ...
      reader.onload = () => {
        setProfileData({ ...profileData, profileImage: reader.result }); // Update profile image
      };
                ...
                {isEditing && (
                  <div className="absolute bottom-0 right-0">
                    <label
                      ...
                      className="p-2 bg-blue-600 rounded-full text-blue hover:bg-blue-700 cursor-pointer"
                    >
                      <Camera className="w-5 h-5 bg-white" />
                    </label>
                    <input
